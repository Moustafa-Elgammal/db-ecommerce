...
%>
   ...
   <%
        ...
        if(s != null){
            ...
            if(errors.size() == 0){
                Query = "SELECT * FROM custmers_t WHERE custmer_email='"+email+"' AND password='"+password+"';";
...
<html>
    <head>
        ...
        <title>Sign In</title>
        <link href="http://localhost:8080/build/Design/Admin/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    </head>
    <body>
