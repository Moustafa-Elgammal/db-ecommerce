...
<!-- JSP tag to show checkoutdisplay -->

        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Billing address</h4>
          <form class="needs-validation" novalidate action="receipt.jsp">
            <div class="row">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="address-line1" id="address" placeholder="1234 Main St" required>
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="address-line2" id="address2" placeholder="Apartment or suite">
            </div>
